...
RUN cd .. \
     ...
     && cd shairport-sync \
     && autoreconf -fi \
     && ./configure --sysconfdir=/etc --with-pa --with-mqtt-client --with-soxr --with-avahi --with-ssl=openssl --with-systemd --with-airplay-2 --with-apple-alac --with-alsa --with-pipe --with-stdout\
     && make \
     && make install
